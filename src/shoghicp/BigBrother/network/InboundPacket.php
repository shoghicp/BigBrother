...
abstract class InboundPacket extends Packet{
	...
	//TODO PREPARE_CRAFTING_GRID_PACKET=0x01;
	const TAB_COMPLETE_PACKET = 0x02;
	...
	const USE_ENTITY_PACKET = 0x0b;
	const KEEP_ALIVE_PACKET = 0x0c;
	const PLAYER_PACKET = 0x0d;
	const PLAYER_POSITION_PACKET = 0x0e;
	const PLAYER_POSITION_AND_LOOK_PACKET = 0x0f;
	const PLAYER_LOOK_PACKET = 0x10;
	//TODO VEHICLE_MOVE_PACKET = 0x11;
	//TODO STEER_BOAT_PACKET = 0x12;
	...
	//TODO CRAFTING_BOOK_DATA = 0x17;
	//TODO RESOURCEPACK_STATUS_PACKET = 0x18;
	//TODO ADVANCEMENT_TAB_PACKET = 0x19;
